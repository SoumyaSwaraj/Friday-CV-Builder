...
?>
        ...
        <div class="card col-sm-12 col-xl-5 mt-2 mb-2 ml-2 mr-2">
          <img class="card-img-top" src="include/resume1.png" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Resume 1</h5>
            <p class="card-text">Select this Template and Instantly Create Beautiful Resume best suited to needs with One-Click.</p>
            <form action="action.php" method="post">
              <input class="form-control" type="text" name="type" value="resume1" hidden="1">
              <input class="form-control" type="text" name="linkh" value="https://livestats.xyz/friday/dashboard/include/resume1/index.php?id=" hidden="1">
              <input class="form-control" type="text" name="tname" value="" placeholder="Resume Identification Name">
              <input class="form-group btn btn-primary" type="submit" name="resumenewbtn" value="Create Your Resume">
            </form>
          </div>
        </div>
        <div class="card col-sm-12 col-xl-5 mt-2 mb-2 ml-2 mr-2">
          <img class="card-img-top" src="include/resume2.png" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Resume 2</h5>
            <p class="card-text">Select this Template and Instantly Create Beautiful Resume best suited to needs with One-Click.</p>
            <form action="action.php" method="post">
              <input class="form-control" type="text" name="type" value="resume2" hidden="1">
              <input class="form-control" type="text" name="linkh" value="https://livestats.xyz/friday/dashboard/include/resume2/index.php?id=" hidden="1">
              <input class="form-control" type="text" name="tname" value="" placeholder="Resume Identification Name">
              <input class="form-group btn btn-primary" type="submit" name="resumenewbtn" value="Create Your Resume">
            </form>
          </div>
