        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <h3 class="text-white mb-0">Resume List</h3>
            </div>
            <div class="table-responsive">
              <table class="table align-items-center table-dark">
                ...
                <tbody>
                	<?php
                	$user=$_SESSION['user'];
                		$query9999="SELECT * FROM resume WHERE user='$user'";
                  ...
                  <tr>
                    ...
                    <td class="text-right">
                      <a href="resumeedit.php?id=<?php echo $row['id']; ?>"><button class="btn bg-gradient-primary text-white">Edit</button></a>
                   
                      <a href="<?php echo $row['link']; ?>"><button class="btn bg-gradient-success text-white">Download/View</button></a>
                    </td>
                  </tr>
