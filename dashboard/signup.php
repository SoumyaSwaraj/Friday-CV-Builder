              ...
              <form role="form" action="action.php" method="post">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="user" placeholder="Username" type="text" value="<?php echo $userx; ?>"  required="1"  pattern="[a-zA-Z0-9]+">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="pin" placeholder="4-digit PIN" type="number" min="999" required="1">
                  </div>
                </div>
                ...
                <div class="text-center">
                  <input type="submit" name="signupbtn" class="btn btn-primary my-4" value="Sign Up">
                </div>
              </form>
            </div>
          </div>
