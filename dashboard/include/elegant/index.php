...
<body>
  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav class="nav-menu">
      <ul>
        ...
        <li><a href="#about"><i class="bx bx-user"></i> <span>About & Skills</span></a></li>
        <li><a href="#resume"><i class="bx bx-file-blank"></i> <span>Resume</span></a></li>
        <li><a href="#services"><i class="bx bx-server"></i> <span>Projects & Achievements</span></a></li>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      ...
      <p>I'm <span class="typed" data-typed-items="<?php echo $row['job1']; ?>, <?php echo $row['job2']; ?>, <?php echo $row['job3']; ?>, <?php echo $row['job4']; ?>"></span></p>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill"><?php echo $row['s3']; ?> <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill"><?php echo $row['s4']; ?> <i class="val">90%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
          ...
          <div class="col-lg-12"><p> My Other Skills are <?php echo $row['skills']; ?></p></div>
        </div>
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Projects</h2>
          <p>My Best Project experiences are as follows :</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <h4><a href="">#Project - <?php echo $row['p1']; ?></a></h4>
              <p><?php echo $row['pd1']; ?></p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-yellow">
              ...
              <h4><a href="">#Project - <?php echo $row['p2']; ?></a></h4>
              <p><?php echo $row['pd2']; ?></p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-red">
              ...
              <h4><a href="">#Project - <?php echo $row['p3']; ?></a></h4>
              <p><?php echo $row['pd3']; ?></p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-teal">
              ...
              <h4><a href="">#Project - <?php echo $row['p4']; ?></a></h4>
              <p><?php echo $row['pd4']; ?></p>
            </div>
          </div>
...
<?php echo $row['about']; ?>    </p>
      ...
      <div class="copyright">
        &copy; Copyright <strong><span>Friday</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://livestats.xyz/friday/">Friday</a>
      </div>
    </div>
  </footer><!-- End Footer -->
