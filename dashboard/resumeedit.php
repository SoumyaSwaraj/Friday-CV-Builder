      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            ...
            <p class="text-white mt-0 mb-5">This is your resume generated under the name : <?php echo $row['tname']; ?>. You can edit and manage your deatils here or on your profile.</p>
          ...
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              ...
              <form action="action.php" method="POST">
                ...
                <div class="form-group">
                  <input class="form-control" type="submit" name="rupdatebtn" value="Update Details">
                </div>
