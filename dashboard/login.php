        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              ?>
              <div class="text-center form-control btn btn-info mb-4">
              ...
              <form role="form" action="action.php" method="post">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="user" placeholder="Username" type="text" required="1">
                  </div>
                </div>
                ...
                <div class="text-center">
                  <input type="submit" name="signinbtn" class="btn btn-primary my-4" value="Log In">
                </div>
              </form>
            </div>
          </div>
