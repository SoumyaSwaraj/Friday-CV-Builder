...
include('stats.php');
$user=$_SESSION['user'];
$query9999="SELECT * FROM user WHERE user='$user'";
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            ...
            <p class="text-white mt-0 mb-5">This is your profile page. You can see the progress you've made with your work and manage your deatils.</p>
          ...
          <div class="card card-profile shadow">
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                <h3>
                  <?php echo $row['name']; ?><span class="font-weight-light">, DOB - <?php echo $row['dob']; ?> </span>
                </h3>
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i><?php echo $row['job1']; ?>
                </div>
                <div class="h5 mt-4">
                  <i class="ni business_briefcase-24 mr-2"></i>Gender : <?php echo $row['gender']; ?>
                </div>
                <div>
          ...
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              ...
              <form action="action.php" method="POST">
                ...
                <div class="form-group">
                  <input class="form-control btn btn-info" type="submit" name="userupdatebtn" value="Update Details">
                </div>
